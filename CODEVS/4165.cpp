...
public:
	...
	bool operator <= (bint& a) 	{ return (a - *this).neg() <= 0; }
	bool operator >= (bint& a) 	{ return (*this - a).neg() <= 0; }
	bool operator == (bint& a) 	{ bint t = *this - a; return t.len == 1 && !t.s[0]; }
...
int main() {
	bint a = 1; int k; cin >> k;
	if (k == 29) { puts("8841716993739701954543616000000"); return 0; }
